                        ...
                        <div class="card-body">
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" readonly class="form-control" id="discount" name="discount" value="{{old('discount')}}">
                                    @error('discount')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="video" name="video" value="{{old('video')}}" placeholder="https://www.youtube.com/watch?v=LJ2KpXcJEr0">
                                    @error('video')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
