...
<script src="{{asset('public/backend/vendor/summernote/summernote.min.js')}}"></script>
{{--<script src="{{asset('public/backend/vendor/ckeditor5-build-classic/ckeditor.js')}}"></script>--}}
